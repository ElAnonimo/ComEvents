...
// exports.find = module.exports = function(req, res, next) {
exports.find = function(req, res, next){
  ...
  req.app.db.models.Event.pagedFind({
    ...
    if (req.xhr) {
      ...
      results.filters = req.query;
      // res.render('events/index', { data: { results: JSON.stringify(results) } });
...
exports.create = function(req, res, next){
  ...
  workflow.on('validate', function() {
    if (!req.body.name) {
      workflow.outcome.errors.push('Please enter an event name');
